...
Sandbox.prototype.start = function () {
  ...
  var listeningListener = function () {
    console.log('sandbox server created', _this.server.address()) // emit data so that sandcastle knows sandbox is created
  }

  this.server.listen(this.socket, listeningListener)
